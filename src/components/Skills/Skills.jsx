        ...
        <div className="knowledge-container">
          <div className="skills-data-container">
            <div className="skills-data">
              ...
              <div className="skills-data--names">html</div>
            </div>
            ...
            <div className="skills-data">
              ...
              <div className="skills-data--names">css</div>
            </div>
              ...
              <div>
                ...
                >
                  <img
                    ...
                    src={IconJs}
                    alt="no-logo"
                    title="Java Script documentation"
                  />
                </a>
              </div>
              <div className="skills-data--names">java script</div>
            </div>
              ...
              <div>
                ...
                >
                  <img
                    ...
                    src={IconTs}
                    alt="no-logo"
                    title="Type Script documentation"
                  />
                </a>
              </div>
              <div className="skills-data--names">type script</div>
            </div>
            ...
            <div className="skills-data">
              ...
              <div className="skills-data--names">react</div>
            </div>
            ...
            <div className="skills-data">
              ...
              <div className="skills-data--names">nodejs</div>
            </div>
            ...
            <div className="skills-data">
              ...
              <div className="skills-data--names">git</div>
            </div>
            ...
            <div className="skills-data">
              ...
              <div className="skills-data--names">sass</div>
            </div>
          </div>
        </div>
        <div className="skill-experience-container">
          <div className="skills-edabit-img">
            <img src={IconEdabit} alt="no-edabit-img" width={150} />
          </div>
          <div className="skills-edabit-dataContainer">
            <div className="skills-edabit-data">
              <h4 className="edabit">edabit platform</h4>
              <div className="skills-edabit-exp edabit">
                <p>Level 22</p>
                <p>16,504 XP</p>
              </div>
              <div className="edabit">
                <p>skill: Hard</p>
              </div>
              <div className="skills-edabit-desc edabit">
                <p>
                  <em>1021 different java script</em>
                </p>
                <p>problems solved</p>
              </div>
            </div>
            <div className="skills-edabitProof-container">
              <img
                onClick={zoom}
                className={`skills-edabit-proof ${
                  checkImgClick === false ? "" : "zoomIn"
                }`}
                src={IconEdabitXp}
                alt="no-proof"
                title="Edabit Proof"
